...
--            'cdc_timestamp')
     ...
     OR tm.source_table_name='obo__image_view' AND cm.source_column_name NOT IN (
            ...
            'enum_name', 
            'description')
     OR tm.source_table_name='obo__kpi_impact_type' AND cm.source_column_name NOT IN (
            'kpi_impact_type_id', 
            'enum_name', 
            'description')
...
--            'last_updated_on')
     ...
     OR tm.source_table_name='obo__scheme_liability_category' AND cm.source_column_name NOT IN (
            ...
            'enum_name', 
            'description')
     OR tm.source_table_name='obo__svc_lvl_domain' AND cm.source_column_name NOT IN (
            'svc_lvl_domain_id', 
            'enum_name', 
            'description')
     OR tm.source_table_name='obo__svc_lvl_impact_details' AND cm.source_column_name NOT IN (
            'slid_id', 
            'svc_lvl_impact_id', 
            'kpi_impact_type_id')
     OR tm.source_table_name='obo__svc_lvl_event_impact_map' AND cm.source_column_name NOT IN (
            'svc_lvl_event_id', 
            'svc_lvl_impact_id', 
            'linked_on')
     OR tm.source_table_name='obo__svc_lvl_event_register' AND cm.source_column_name NOT IN (
            'svc_lvl_event_id', 
            'svc_lvl_event_type_id', 
            'svc_lvl_event_status_id', 
            'svc_lvl_event_status_timestamp', 
            'svc_lvl_event_category_id', 
            ...
            'registered_on', 
            'last_updated_by_sid', 
            'last_updated_by_euid', 
            'last_updated_on')
     OR tm.source_table_name='obo__svc_lvl_impact_register' AND cm.source_column_name NOT IN (
            'svc_lvl_impact_id', 
            'svc_lvl_impact_type_id', 
            'svc_lvl_impact_status_id', 
            'svc_lvl_impact_status_timestamp', 
            'svc_lvl_impact_domain_id', 
            'event_start_timestamp', 
            'event_end_timestamp', 
            'impacted_control_point_id', 
            'impacted_road_section_id', 
            'impacted_service_name', 
            'registered_by_sid', 
            'registered_by_euid', 
            'registered_on', 
            'last_updated_by_sid', 
            'last_updated_by_euid', 
            'last_updated_on')
     OR tm.source_table_name='obo__svc_lvl_impact_status' AND cm.source_column_name NOT IN (
            'svc_lvl_impact_status_id', 
            'enum_name', 
            'description')
