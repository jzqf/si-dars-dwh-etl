#!/bin/bash
#
# This script updates the tables in the TDP data warehouse (DWH) that comprise 
# the star-schema TDP data mart.
#
...
$DWH_HOME/bin/kitchen.sh /dwh_tdp/data_mart/jb_dwh_tdp_data_mart-update.kjb
