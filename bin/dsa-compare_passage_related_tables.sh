...
#
# This script assumes that the passage related tables in the DSA will be 
...
#
#   sudo su -l -s /bin/bash dwh_etl -c "/opt/qfree/dwh_etl/bin/dsa-compare_passage_related_tables.sh '2020-01-01 00:00:00' '2020-02-01 00:00:00' Minimal"
#
# or:
#
#   sudo su -l -s /bin/bash dwh_etl
#   cd /opt/qfree/dwh_etl/bin/
#   ./dsa-compare_passage_related_tables.sh '2020-01-01 00:00:00' '2020-02-01 00:00:00' Minimal"
#
# Version history:
#
# Version:  1.0
